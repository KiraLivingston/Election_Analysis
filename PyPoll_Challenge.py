...
with open(file_to_save, "w") as txt_file:
    ...
    for county_option in county_votes:
        ...
        votes_county = county_votes.get(county_option)
        # 6c: Calculate the percentage of votes for the county.
        votes_county_percentage = int(votes_county) / int(total_votes) * 100

        # 6d: Print the county results to the terminal.
    
        # 6e: Save the county votes to a text file.
        county_results = (
            f"{county_option}: {votes_county_percentage:.1f}% ({votes_county:,})\n")
    ...
    print(winning_county_percent)
    txt_file.write(winning_county_percent)
